...
class ApplicationRepository extends Repository<Profile> {
  final AuthenticationRepository _accountRepository;
  ...
  Future<Profile> getData() async {
    try {
      ...
      await requests.updateToken(
          _accountRepository.login, _accountRepository.password);
